...
<tr>
 ...
 <td>Разработка модели для сервиса заказов такси, которая прогнозирует кол-во заказов такси на следующий час. Модель служит для дополнительного привлечения водителей в период пиковой нагрузки</td>
 <td>Учебный проект, Яндекс Практикум</td>
</tr>
</table>
