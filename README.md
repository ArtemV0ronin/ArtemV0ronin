...
<tr>
 ...
 <td>Разработка модели на базе свёрточной нейросети ResNet50 для определения возраста покупателей по фотографии в прикассовой зоне магазина. Модель используется при анализе покупок, чтобы предлагать товары, которые могут заинтересовать покупателей разных возрастных групп, а так же для контроля кассиров при продаже алкоголя.
