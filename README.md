...
<tr>
 ...
 <td>Анализ, EDA</td>
 <td>Исследовательский анализ данных о продажах интернет-магазина видеоигр. Определение потенциально популярного продукта. Рекомендации заказчку по планированию рекламных кампаний магазина на следующий год</td>
